...
class gps_msg(genpy.Message):
  _md5sum = "b4fe85f1fca2fd6e851c83be21ce5089"
...
string frame_id
"""
  __slots__ = ['Header','Latitude','Longitude','Altitude','HDOP','UTM_northing','UTM_easting','UTC','Zone','Letter']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Header,Latitude,Longitude,Altitude,HDOP,UTM_northing,UTM_easting,UTC,Zone,Letter
