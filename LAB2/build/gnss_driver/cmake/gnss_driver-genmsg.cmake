...
message(STATUS "gnss_driver: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ignss_driver:/home/srinidhi/EECE5554/LAB2/src/gnss_driver/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/srinidhi/EECE5554/LAB2/src/gnss_driver/msg/gnss_msg.msg" NAME_WE)
add_custom_target(_gnss_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gnss_driver" "/home/srinidhi/EECE5554/LAB2/src/gnss_driver/msg/gnss_msg.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(gnss_driver
  "/home/srinidhi/EECE5554/LAB2/src/gnss_driver/msg/gnss_msg.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gnss_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gnss_driver\")")
  # install generated code
  install(
